//! Taken from std, <https://github.com/rust-lang/rust/tree/485ec3fbcc12fa14ef6596dabb125ad710499c9e/library/alloctests/testing/macros.rs>
...
macro_rules! struct_with_counted_drop {
    ...
    ($struct_name:ident $(( $( $elt_ty:ty ),+ ))?, $drop_counter:ident[ $drop_key:expr,$key_ty:ty ] $( => $drop_stmt:expr )? ) => {
        thread_local! {
            static $drop_counter: ::core::cell::RefCell<::core::collections::HashMap<$key_ty, u32>> =
                ::core::cell::RefCell::new(::core::collections::HashMap::new());
        }
