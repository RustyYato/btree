//! Taken from std, <https://github.com/rust-lang/rust/tree/beae781308e9ddef13074a03faf57ca2fac59a5b/library/alloc/src/collections/btree/map/tests.rs>
...
mod test_extract_if {
    ...
    fn drop_panic_leak() {
        ...
        catch_unwind(move || {
            map.extract_if(.., |dummy, _| dummy.query(true))
                .for_each(drop)
        })
        .unwrap_err();
